...
class TriggerDefinitionMutatorProviderTest extends FhirFuzzingMutatorTest {
  ...
  void shouldNotThrowAnything(TriggerDefinition triggerDefinition) {
    val mutatorProvider = new TriggerDefinitionMutatorProvider();

    mutatorProvider
        .getMutators()
        .forEach(
            m -> {
              assertDoesNotThrow(() -> m.apply(this.ctx, triggerDefinition));
  ...
  static Stream<Arguments> shouldNotThrowAnything() {
    return Stream.of(
            ...
            new TriggerDefinition().setType(TriggerDefinition.TriggerType.DATAADDED),
            new TriggerDefinition()
