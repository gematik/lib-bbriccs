...
class MedicationMutatorProviderTest extends FhirFuzzingMutatorTest {
  ...
  void shouldNotThrowAnything(File f) {
    ...
    val medication =
        bundle.getEntry().stream()
            ...
            .findFirst()
            .orElseThrow();
    val mutatorProvider = new MedicationMutatorProvider();

    mutatorProvider
        .getMutators()
        .forEach(
            m -> {
              assertDoesNotThrow(() -> m.apply(this.ctx, medication));
