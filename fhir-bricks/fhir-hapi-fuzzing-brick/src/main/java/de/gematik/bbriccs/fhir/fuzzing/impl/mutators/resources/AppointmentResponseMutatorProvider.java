...
public class AppointmentResponseMutatorProvider
    extends BaseDomainResourceMutatorProvider<AppointmentResponse> {
  ...
  private static List<FuzzingMutator<AppointmentResponse>> createMutators() {
    val mutators = new LinkedList<FuzzingMutator<AppointmentResponse>>();
    ...
    mutators.add((ctx, apt) -> ctx.fuzzChild(apt, apt::hasActor, apt::getActor));
