...
public class SearchQueryParameter implements QueryParameter {

  private final String parameter;
  private final String value;

  public SearchQueryParameter(String parameter, String value) {
   ...
   * @param value
   */
  public SearchQueryParameter(String parameter, SearchPrefix prefix, String value) {
    this.parameter = parameter;
