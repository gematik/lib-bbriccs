...
class FhirBResponseTest {

  @Test
  void shouldProvideEmptyResourceOnNullBody() {
    val response = FhirBResponse.forPayload(Bundle.class, null).andValidationResult(null);
  ...
  void shouldProvideCorrectResourceTypeRegardlessOfExpectation() {
    val response = FhirBResponse.forPayload(Bundle.class, new Task()).andValidationResult(null);
