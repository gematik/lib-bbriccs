...
class VauClientTest {
  ...
  void shouldHandleResponse() {
    ...
    val request =
        HttpBRequest.post()
            .urlPath("/Task")
            .headers(JwtHeaderKey.AUTHORIZATION.createHeader("IDP_Token"))
            .withPayload("What's wrong, McFly? Chicken!");
  ...
  void shouldThrowOnMissingJwtToken() {
    ...
    val request = HttpBRequest.post().urlPath("/Task").withPayload("What's wrong, McFly? Chicken!");
  ...
  void shouldHandleUnencryptedResponse500() {
    ...
    val request =
        HttpBRequest.delete()
            ...
            .withPayload("Nobody calls me chicken");
