...
@Data
public class KonnektorConfiguration implements BaseConfigurationDto, NamedConfigurationElement {

  private String name;
  private KonnektorContextConfiguration context;
  private KonnektorServiceConfiguration service;
  private List<CardTerminalConfiguration> cardTerminals;
}
