...
public class EncryptDocumentRequest extends AbstractKonnektorRequest<byte[]> {

  private final CardInfo cardInfo;
  private final byte[] payload;
  private final CryptoSystem cryptoSystem;

  public EncryptDocumentRequest(CardInfo cardInfo, byte[] payload, CryptoSystem cryptoSystem) {
