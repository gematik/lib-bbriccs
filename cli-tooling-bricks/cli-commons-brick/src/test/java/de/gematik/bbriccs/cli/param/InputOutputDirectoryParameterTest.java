...
class InputOutputDirectoryParameterTest {
  ...
  void shouldUseInputAsOutputOnMissingOutputPath() {
    ...
    assertEquals(inputDirectory, io.getOut().toString());
  }
  ...
  void shouldWriteToDirectory() {
    ...
    io.writeFile("hello_world.txt", "Hello World");
    assertTrue(Files.exists(Path.of(outputDir, "hello_world.txt")));
  }
